# Generated by Powerlevel10k configuration wizard on 2024-12-28 at 15:11 PST.
  ...
  function my_git_formatter() {
    ...
    if (( VCS_STATUS_COMMITS_AHEAD || VCS_STATUS_COMMITS_BEHIND )); then
      ...
      # res+=" ${clean}="
		...
		# Using model above for ahead/behind, comment this area out to avoid duplication
		#
